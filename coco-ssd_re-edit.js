!function (e, a) {
    ...
    function n(e, a, i, n) {
        return new (i || (i = Promise))((function (t, m) {
            function d(e) {
                try { o(n.next(e)) } catch (e) { m(e) }
            } function s(e) {
                try { o(n.throw(e)) } catch (e) { m(e) }
            } function o(e) {
                var a; e.done ? t(e.value) : (a = e.value, a instanceof i ? a : new i((function (e) {
                    e(a)
                }))).then(d, s)
        ...
        var i, n, t, m, d = {
            label: 0, sent: function () { if (1 & t[0]) throw t[1]; return t[1] }, trys: [], ops: []
        };
        return m = {
            ...
            return this
                ...
                {
                    return function (m) {
                        if (i) throw new TypeError("Generator is already executing."); for (; d;)try {
                            ...
                            switch (n = 0, t && (m = [2 & m[0], t.value]), m[0]) {
                                case 0:
                                case 1: t = m; break;
                                case 4: return d.label++ , { value: m[1], done: !1 };
                                case 5: d.label++ , n = m[1], m = [0]; continue;
                                case 7: m = d.ops.pop(), d.trys.pop(); continue;
                                default: if (!(t = d.trys, (t = t.length > 0 && t[t.length - 1]) || 6 !== m[0] && 2 !== m[0])) {
                                    d = 0; continue
                                } if (3 === m[0] && (!t || m[1] > t[0] && m[1] < t[3])) {
                                    d.label = m[1]; break
                                    } if (6 === m[0] && d.label < t[1]) {
                                        d.label = t[1], t = m; break
                                    } if (t && d.label < t[2]) {
                                        d.label = t[2], d.ops.push(m); break
                                    } t[2] && d.ops.pop(), d.trys.pop(); continue
                            }m = a.call(e, d)
                        } catch (e) { m = [6, e], n = 0 } finally { i = t = 0 } if (5 & m[0]) throw m[1]; return { value: m[0] ? m[1] : void 0, done: !0 }
                    }([m, s])
                }
            }
    } var m = {
        ...
        function e(e, a) {
            this.modelPath = a || "".concat("https://storage.googleapis.com/tfjs-models/savedmodel/").concat(this.getPrefix(e), "/model.json")
        }
        return e.prototype.getPrefix = function (e) {
            ...
            return n(this, void 0, void 0, (function () {
                ...
                return t(this, (function (t) {
                    switch (t.label) {
                        case 0: return e = this, [4, a.loadGraphModel(this.modelPath)];
                        case 1: return e.model = t.sent(), n = i.zeros([1, 300, 300, 3], "int32"), [4, this.model.executeAsync(n)];
                        case 2: return m = t.sent(), [4, Promise.all(m.map((function (e) { return e.data() })))];
                        case 3: return t.sent(), m.map((function (e) { return e.dispose() })), n.dispose(), [2]
                    }
                }))
            }))
                ...
                return t(this, (function (t) {
                    switch (t.label) {
                        case 0:
                            ...
                            return e instanceof i.Tensor || (e = i.browser.fromPixels(e)), i.expandDims(e)
                        })), d = n.shape[1], s = n.shape[2], [4, this.model.executeAsync(n)];
                        case 1:
                            return o = t.sent(), r = o[0].dataSync(), l = o[1].dataSync(), n.dispose(), i.dispose(o), p = this.calculateMaxScores(r, o[0].shape[1], o[0].shape[2]), c = p[0], y = p[1], u = i.getBackend(), "webgl" === i.getBackend() && i.setBackend("cpu"), f = i.tidy((function () {
                                var e = i.tensor2d(l, [o[1].shape[1], o[1].shape[3]]);
                                return i.image.nonMaxSuppression(e, c, a, m, m)
                        })), b = f.dataSync(), f.dispose(), u !== i.getBackend() && i.setBackend(u), [2, this.buildDetectedObjects(s, d, l, c, b, y)]
                    }
                }))
            }))
            }, e.prototype.buildDetectedObjects = function (e, a, i, n, t, d) {
            for (var s = t.length, o = [], r = 0; r < s; r++) { for (var l = [], p = 0; p < 4; p++)l[p] = i[4 * t[r] + p]; var c = l[0] * a, y = l[1] * e, u = l[2] * a, f = l[3] * e; l[0] = y, l[1] = c, l[2] = f - y, l[3] = u - c, o.push({ bbox: l, class: m[d[t[r]] + 1].displayName, score: n[t[r]], ident: m[d[t[r]] + 1].id }) }  // This is the change
            return o
            }, e.prototype.calculateMaxScores = function (e, a, i) {
            for (var n = [], t = [], m = 0; m < a; m++){ for (var d = Number.MIN_VALUE, s = -1, o = 0; o < i; o++)e[m * i + o] > d && (d = e[m * i + o], s = o); n[m] = d, t[m] = s }
            return [n, t]
            }, e.prototype.detect = function (e, a, i) {
            return void 0 === a && (a = 20), void 0 === i && (i = .5), n(this, void 0, void 0, (function () {
    ...
    }(); e.ObjectDetection = d, e.load = function (e) {
            ...
            return t(this, (function (t) {
                switch (t.label) {
                    case 0:
                        ...
                        if (a = e.base || "lite_mobilenet_v2", n = e.modelUrl, -1 === ["mobilenet_v1", "mobilenet_v2", "lite_mobilenet_v2"].indexOf(a)) throw new Error("ObjectDetection constructed with invalid base model " + "".concat(a, ". Valid names are 'mobilenet_v1',") + " 'mobilenet_v2' and 'lite_mobilenet_v2'.");
    ...
    }, e.version = "2.2.3", Object.defineProperty(e, "__esModule", { value: !0 })
}));
